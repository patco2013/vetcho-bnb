...
class Ad
{
     ...
     *          min = 10,
     *          max = 255,
     *          minMessage = "Votre titre doit avoir au moins 10 caractères",
     ...
     * @Assert\length(
     *          min = 20,
     *          minMessage = "Votre introduction doit faire au moins 20 caractère" 
     * )
     */
    ...
    /**
     * Allows you to initialize the slug/Permet d'initialiser le slug
     * 
     * @ORM\PrePersist
     * @ORM\PreUpdate
     *
